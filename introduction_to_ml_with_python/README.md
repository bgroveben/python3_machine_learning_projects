...
I am here:
Chapter 3 -- Unsupervised Learning and Preprocessing -- Comparing and Evaluating Clustering Algorithms -- Comparing algorithms on the faces dataset -- Analyzing the faces dataset with k-means
