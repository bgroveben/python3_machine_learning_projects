...
I am here:
Chapter 3 -- Unsupervised Learning and Preprocessing -- Challenges in Unsupervised Learning -- Dimensionality Reduction, Feature Extraction, and Manifold Learning  -- Non-Negative Matrix Factorization (NMF) -- Applying NMF to face images
